...
<body>
    ...
    <div class="main-cont and-center">
        <form method="POST" class="w3-card w3-animate-opacity real-form">
            <h2><i class="fa fa-sign-in"></i> Login to our ToDo App</h2>
            <hr>

            <?php
            // Incorrect username
            if (isset($_GET['error'])) {
                echo '<div class="w3-text-red">Those credentials do not exist.</div>';
            }
            
            // Check if still logged in
            elseif (isset($_SESSION['username'])) {
                echo '<div class="w3-text-orange">You are still logged in. Please <a href="index.php">click here</a>.</div>';
            }
            ?>
            ...
            <div class="input-box" style="margin-top: 0;">
                <a href="signup.php" class="w3-btn w3-blue">Sign-up</a>
            </div>
